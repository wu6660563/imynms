<%@page import="com.mynms.performance.model.PerformanceNetInfo"%>
<%@page import="com.mynms.common.util.page.Page"%>
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<%
    String path = request.getContextPath();
    String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
    List<PerformanceNetInfo> list = (List<PerformanceNetInfo>) request.getAttribute("list");
...
<html>
    <head>
        ...
        <title>网络设备性能信息</title>
        
    	<meta http-equiv="pragma" content="no-cache">
    	<meta http-equiv="cache-control" content="no-cache">
    	<meta http-equiv="expires" content="0">    
    	<meta http-equiv="description" content="网络设备性能信息">
            ...
            <div id="page" data-role="page" style="height: 100%">
                <div style="padding: 5px 15px; " data-role="content">
                    <ul id="listview" data-role="listview" data-inset="true">
                        <li data-role="list-divider" class="list-divider">网络设备性能信息</li>
                        ...
                        if (list!=null && list.size() != 0) {
                        	for (PerformanceNetInfo info : list) {
    ...
    <script type="text/javascript">
        ...
        var scrollPagination = new ScrollPagination({
            ...
            'url' : '<%=path%>' + '/performanceNetInfo/list.do',
            'scrollTarget' : $(window),
            'heightOffset' : 10,
            'beforeLoad' : function() {
        ...
        function search() {
            ...
            mainForm.action = "<%=path%>/performanceNetInfo/list.do";
            mainForm.submit();
        }
    </script>
</html>
