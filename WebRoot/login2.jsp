    ...
    <body style="margin: 0px;">
        <div id="page" data-role="page" style="height:100%;width:100%;">
            <div data-role="content" style="height: 100%">
                ...
                <form method="POST" action="<%=path%>/login/login.do" style="height: 100%">
                    ...
                    <div data-role="fieldcontain" style="height: 100%;top:50px;margin: 10% 5%;">
                        ...
                        <div class="ui-grid-a">
                            <div class="ui-block-a"><input value="登    陆" type="submit" data-theme="b" style="font-size: 30px;font-weight: bold;"></div>
