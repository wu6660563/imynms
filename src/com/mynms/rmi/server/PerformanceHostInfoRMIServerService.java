/*
 * @(#)PerformanceHostInfoRMIServerService.java     v1.01, 2012-8-1
 *
...
/**
 * ClassName:   PerformanceHostInfoRMIServerService.java
 ...
 */
public class PerformanceHostInfoRMIServerService extends
                BaseRMIServerService<PerformanceHostInfo,
                                    Integer,
                                    PerformanceHostDAO,
                                    PerformanceHostService> {
    ...
    public RMIAttribute execute(RMIParameter parameter) {
        ...
        try {
            List<PerformanceHostInfo> list = (List<PerformanceHostInfo>)
                                parameter.getParameter("list");
            PerformanceHostService service = getService();
            service.deleteAll();
